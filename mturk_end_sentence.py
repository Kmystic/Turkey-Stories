...
class EndSentenceHit(object):
  ...
  def __init__(self, _access_id, _secret_key, _host, _story_sentences):
      ...
      self.title = 'Finish a story by adding a concluding sentence to provided incomplete story.'
      self.description = ('An incomplete story is provided, add a sentence to complete the story')
